...
<textarea readonly  class="ckeditor"  id="article_head_line_id" name="txtArticleHeadLine" ><?php echo set_value('txtArticleHeadLine'); ?><?php  if(isset($get_article_details['title'])) echo $get_article_details['title']; ?></textarea>
  ...
  <select style="pointer-events:none;" name="ddMainSection" class="controls" id="main_section_id" section_data="<?php echo $select_parent_name; ?>" Value="<?php echo set_value('ddMainSection'); ?><?php echo @$get_article_details['Section_id']; ?>">
...
<textarea readonly class="ckeditor" id="body_text" name="txtBodyText"><?php if(isset($get_article_details['ArticlePageContentHTML'])) echo $get_article_details['ArticlePageContentHTML']; echo set_value('txtBodyText'); ?></textarea>
 ...
 <span id="article_body_error"></span>
            ...
            <div class="article_image" style="pointer-events:none;">
            <p>Images</p>
           ...
           <a id="delete_article_image" rel="home" class="del_image" href="javascript:void(0);"  <?php if((isset($get_article_details['homepageimageid']['temp_id']) && $get_article_details['homepageimageid']['temp_id'] != '') ) { ?>  <?php } else {  ?>   style="display:none;" <?php  } ?> ><i class="fa fa-trash-o"></i></a> 
            ...
            <div style="pointer-events:none;"  id="ArticleImageContainerId" class="ArticleImageContainer" <?php if($page_name == 'edit_article' && isset($get_article_details['homepageimageid']['temp_id']) == '' && isset($get_article_details['Sectionimageid']['temp_id']) == '' && isset($get_article_details['articleimageid']['temp_id']) == ''  ) { echo $display_none; }  if($page_name != 'edit_article') {  echo $display_none;   } ?> >
...
<label>Agency<!--<sup>*</sup> --></label>
  <select style="pointer-events:none;" name="ddAgency"  class="controls" id="agency_id"  >
...
-->
 ...
 <input disabled type="text" name="txtByLine" id="txtByLine"  value="<?php if(isset($select_author) && $select_author != "") {  echo htmlentities($select_author); } echo set_value('txtbyline'); ?>" maxlength="50" />
    ...
    <?php echo form_error('ddByLine'); ?>
            ...
            <div class="w2ui-field">
<label>Country</label>
  <select style="pointer-events:none;" name="ddCountry"  class="controls" id="country_id" value="<?php echo set_value('ddCountry'); ?>">
    <option value="">-Select-</option>
  ...
  <select name="ddState"  class="controls" id="state_id" value="<?php echo set_value('ddState'); ?>" >
   ...
   <input readonly type="text" name="txtState" id="txtState" value="<?php if(isset($select_state) && $select_state != "") {  echo $select_state; } echo set_value('txtState'); ?>"  />
    ...
    <?php echo form_error('ddCity'); ?>
         ...
         <div class="article_attribute" style="pointer-events:none;">
            <h3>Schedule</h3>
