...
foreach($authors as $data)
{
	...
	//added by krishwer to render values of byline 
	$Phone=$data['mobile'];
			...
			<div class="tabs Overflow" style="margin-top:10%;">
				...
				<div class="content">
					<div class="columnist1">
						...
						<p>Phone Number</p>
						<p>
						<input id="phonenumber" class="box-shad box-shad1" name="txtphone"  type="text" placeholder="" maxlength="100" value="<?php if(isset($Phone)){ echo $Phone;}?>">
						
						</p>
						<p>Facebook Link</p>
						<p>
						<input id="txtfacebook" class="box-shad box-shad1" name="txtfacebook"  type="text" placeholder="" maxlength="100" value="<?php if(isset($Facebook)){ echo $Facebook;}?>">
						
						</p>
						<p>Twitter Link</p>
						<p>
						<input id="txttwitter" class="box-shad box-shad1" name="txttwitter"  type="text" placeholder="" maxlength="100" value="<?php if(isset($Twitter)){ echo $Twitter;}?>">
						
						</p>
						<p>Instagram Link</p>
						<p style=" margin-bottom: 8px;">
						<input id="txtinstagram" class="box-shad box-shad1" name="txtinstagram"  type="text" placeholder="" maxlength="100" value="<?php if(isset($Instagram)){ echo $Instagram;}?>">
					...
					<div class="columnist2">
						<div class="columnist2a" id="call_show2">
							<figure> Profile Image<br />
								...
								<p>Supported image size 300X300 pixels</p>
