...
$share_url    = BASEURL.$page_det['url'];
...
<html>
<head>
<link rel="alternate" href="<?php echo $share_url; ?>" hreflang="en"/>
...
<?php
	$jsonImage = (@$page_det['article_page_image_path']!='')? image_url_no . imagelibrary_image_path . @$page_det['article_page_image_path'] : image_url_no . imagelibrary_image_path .'logo/nie_logo_600X390.jpg' ;
