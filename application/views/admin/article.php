  ...
  <!--<section id="examples">
		...
		<div class="article_attribute">
			...
			<div class="article_tag"> 
				<section id="examples">
				<div class="example example_markup">
					<div id="seo_tagform_full"  class="bs-example">
						<?php if(isset($seo_tags)) { 
							foreach($seo_tags as $seo_tag) { ?>
							<input type="text" name="seo_txtTags[<?php echo $seo_tag->tag_id; ?>-a]" id="tags_id"  value="<?php echo $seo_tag->tag_name; ?>" class="tag"/>
						<?php }  } else { ?>
							<input type="text" name="seo_txtTags[]" id="tags_id"  value="" class="tag"/>
						<?php } ?>	
					</div>
				</div>
				</section> 
